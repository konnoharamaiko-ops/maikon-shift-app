...
export default function UserEdit() {
  ...
  useEffect(() => {
    if (targetUser) {
      ...
      setEditedUser({
        ...
        belongs_tokuhan: targetUser.belongs_tokuhan || false,
        belongs_online: targetUser.belongs_online || false,
        belongs_planning: targetUser.belongs_planning || false,
        belongs_hokusetsu: targetUser.belongs_hokusetsu || false,
        belongs_kagaya: targetUser.belongs_kagaya || false,
        belongs_minamitanabe: targetUser.belongs_minamitanabe || false,
        belongs_ekimaru: targetUser.belongs_ekimaru || false,
  ...
  const handleSave = () => {
    ...
    const saveData = {
      ...
      belongs_tokuhan: editedUser.belongs_tokuhan || false,
      belongs_online: editedUser.belongs_online || false,
      belongs_planning: editedUser.belongs_planning || false,
      belongs_hokusetsu: editedUser.belongs_hokusetsu || false,
      belongs_kagaya: editedUser.belongs_kagaya || false,
      belongs_minamitanabe: editedUser.belongs_minamitanabe || false,
      belongs_ekimaru: editedUser.belongs_ekimaru || false,
